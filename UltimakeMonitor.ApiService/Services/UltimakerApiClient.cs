...
public class UltimakerApiClient
{
    ...
    public async Task<UltimakerPrinterInfo?> GetPrinterInfoAsync(string ipAddress, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            _logger.LogWarning("Failed to get printer info from {IpAddress}: {StatusCode}", ipAddress, response.StatusCode);
            return null;
        }
        catch (Exception ex)
        {
    ...
    public async Task<UltimakerPrintJobStatus?> GetPrintJobStatusAsync(string ipAddress, CancellationToken cancellationToken = default)
    {
        try
        {
            using var httpClient = CreateHttpClient();
    ...
    public async Task<UltimakerPrinterStatus?> GetPrinterStatusAsync(string ipAddress, CancellationToken cancellationToken = default)
    {
        try
        {
            using var httpClient = CreateHttpClient();
